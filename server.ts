...
async function startServer() {
  ...
  // Hostinger akan memberikan PORT melalui environment variable.
  // Saat dijalankan di komputer sendiri, server memakai port 3000.
  ...
  app.post("/api/register", async (req, res) => {
    ...
    try {
      ...
      await pool.query(
        ...
        VALUES (?, ?, ?)`,
        [studentId, account.username, hashedPassword],
      );
  ...
  // =========================================================
  // ADMIN: MENGAMBIL DATA PENDAFTAR
  // =========================================================
  ...
  // =========================================================
  // VITE DAN FILE WEBSITE
  // =========================================================

  if (process.env.NODE_ENV !== "production") {
    // Mode development di komputer sendiri.
    ...
    // Mode production di Hostinger.
    // Menampilkan hasil build React dari folder dist.
  ...
  // Membuat URL React seperti /login, /dashboard,
  // /student dan URL lainnya tetap bisa dibuka langsung.
  // Route /api tidak akan diarahkan ke index.html.
...
// Menjalankan aplikasi dan menampilkan error jika server gagal dimulai.
